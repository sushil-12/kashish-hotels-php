...
$template = file_get_contents('contact.html');
...
if (empty($name) || empty($phone) || empty($message) || empty($email)) {
    ...
    $mail->isHTML(true);
    $subject = "Enquiry from Kashish Hotels Website tried to connected";
